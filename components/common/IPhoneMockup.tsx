...
const IPhoneMockup: React.FC<IPhoneMockupProps> = ({ children, className = '' }) => (
  <div className={`relative w-[260px] sm:w-[280px] lg:w-[300px] mx-auto ${className}`}>
    {/* Phone body */}
    <div
      className="relative mx-auto bg-neutral-darkest border-neutral-darkest border-[10px] sm:border-[12px] rounded-[40px] sm:rounded-[46px] w-full dark:ring-1 dark:ring-white/10"
