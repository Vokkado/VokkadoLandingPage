/**
 * Los iconos del sitio, adentro del bundle.
 *
 * Antes venían de ionicons por CDN: un módulo de unpkg que además pedía cada
 * icono como un SVG aparte, o sea decenas de requests a un tercero solo para
 * dibujar flechitas. Acá están los 54 que se usan de verdad, extraídos de
 * ionicons 7.1.0 (MIT, https://github.com/ionic-team/ionicons).
 *
 * Es contenido estático, sacado de los archivos originales en tiempo de build.
 * No entra nada de afuera, por eso se puede inyectar como HTML.
 *
 * Para sumar uno: bajar el svg de ionicons, copiar lo de adentro de <svg> acá
 * con el mismo nombre, y usarlo con <Icono nombre="..." />.
 */
...
export const ICONOS: Record<string, string> = {
  ...
  'checkmark-circle-outline':
    '<path d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M352 176L217.6 336 160 272"/>',
  ...
  'fitness-outline':
    '<path d="M352.92 80C288 80 256 144 256 144s-32-64-96.92-64c-52.76 0-94.54 44.14-95.08 96.81-1.1 109.33 86.73 187.08 183 252.42a16 16 0 0018 0c96.26-65.34 184.09-143.09 183-252.42-.54-52.67-42.32-96.81-95.08-96.81z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M48 256h112l48-96 48 160 48-96 32 64h128"/>',
  'flash-outline':
  ...
  'flask-outline':
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M176 48h160M118 304h276M208 48v93.48a64.09 64.09 0 01-9.88 34.18L73.21 373.49C48.4 412.78 76.63 464 123.08 464h265.84c46.45 0 74.68-51.22 49.87-90.51L313.87 175.66a64.09 64.09 0 01-9.87-34.18V48"/>',
  'folder-open-outline':
  ...
  'lock-closed-outline':
    '<path d="M336 208v-95a80 80 0 00-160 0v95" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><rect x="96" y="208" width="320" height="272" rx="48" ry="48" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/>',
  'logo-instagram':
  ...
  'trending-up-outline':
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M352 144h112v112"/><path d="M48 368l121.37-121.37a32 32 0 0145.26 0l50.74 50.74a32 32 0 0045.26 0L448 160" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/>',
};
